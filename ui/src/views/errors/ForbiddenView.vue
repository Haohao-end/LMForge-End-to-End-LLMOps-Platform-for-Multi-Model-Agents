  ...
  <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-5xl px-4">
    <div class="flex items-center">
      <div class="relative w-1/2">
        ...
        <img class="absolute w-30 h-30 left-cloud animate-cloudLeft" src="@/assets/images/404_cloud.png" alt="cloud" />
        <img class="absolute w-32 h-30 mid-cloud animate-cloudMid" src="@/assets/images/404_cloud.png" alt="cloud" />
        <img class="absolute w-36 h-30 right-cloud animate-cloudRight" src="@/assets/images/404_cloud.png" alt="cloud" />
      </div>
